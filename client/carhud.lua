...
HideHudComponentThisFrame(10)  -- Street Name
HideHudComponentThisFrame(11)  -- Street Name
HideHudComponentThisFrame(12)  -- Street Name
HideHudComponentThisFrame(13) -- Cash Change
HideHudComponentThisFrame(14)  -- Street Name
HideHudComponentThisFrame(15)  -- Street Name
HideHudComponentThisFrame(16)  -- Street Name
HideHudComponentThisFrame(17)  -- Street Name
HideHudComponentThisFrame(18) -- Save Game
HideHudComponentThisFrame(19)  -- Street Name
HideHudComponentThisFrame(20) -- Weapon Stats
HideHudComponentThisFrame(21)  -- Street Name
HideHudComponentThisFrame(22)  -- Street Name
end)
			...
			if IsControlJustReleased(0,  Keys['B']) then
				...
				if(PedVehIsCar)then
					...
					if seatbeltIsOn then
						...
						TriggerEvent("mole_notifications:SendNotification", {text = "Zapnul sis bezpečnostní pás", type = "success", timeout = 1400})
						TriggerServerEvent('esx_mole_misiones:PlayOnSource','buckle', 0.9)
					else
						TriggerEvent("mole_notifications:SendNotification", {text = "Odepnul sis bezpečnostní pás", type = "error", timeout = 1400})
